	...
	public void onConnectionFailed(ConnectionResult connectionResult) {
		if (connectionResult.hasResolution()) {
			try {
				...
				// Log the error
				Log.e(getClass().getName(), "onConnectionFailed", e);
			}
		} else {
	...
	*/
	...
	public void getAddress() {
		...
		if (servicesConnected()) {
			...
			if (currentLocation != null) {
				...
				(new ViewTasksActivity.GetAddressTask(this))
						.execute(currentLocation);
			} else {
				Toast.makeText(this, "Could not get last location !",
						Toast.LENGTH_LONG).show();
			}
		}
	}
	...
	public void onClick(View view) {
		...
		if (view.getId() == R.id.remove_button) {
			...
			Intent intent = new Intent(ViewTasksActivity.this,
